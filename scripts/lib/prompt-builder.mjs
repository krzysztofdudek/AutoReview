...
Check every statement in the rule against the code. Evaluate the entire file state.
...
export function buildPrompt({ rule, file, diff, mode }) {
  const task = `<task>\n${TASK_BODY.replace('{mode}', mode)}\n</task>`;
